...
export default function BookingCard(props) {
  return (
    <Card className="w-full max-w-[26rem] h-[450px] shadow-lg flex flex-col justify-between">
      <CardHeader floated color="blue-gray">
        <img
          src={props.image}
      ...
      <CardBody>
        ...
        <div className="group mt-8 inline-flex flex-wrap items-center gap-2 ">
          <Tooltip content={`Event Type: ${props.eventType}`}>
      ...
      <CardFooter className="pt-3 flex justify-center">
        ...
        variant="outlined"
        fullWidth
        className=" rounded-3xl hover:bg-black hover:text-white group ">
          Buy Now
        </Button>
      </CardFooter>
    </Card>
